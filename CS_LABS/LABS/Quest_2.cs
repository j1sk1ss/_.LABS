...
namespace CS_LABS.LABS
{
    public class Quest2 : Labs
    {
        ...
        public void
            Work_1() // Есть последовательность, надо задать Е и кол-во элементов посл.
                     // а после выводится ответ мол сумма эл., модуль который выше Е.
        {
        ...
        public void
            Work_3() // Задание в том, что бы из заданного массива получить минимальное число и максимальное, а после вывести их сумму. 
        {
        ...
        public void
            Work_4() // Задание в том что бы после обьеденения последовательности числа так же были отсартированны.
        {
