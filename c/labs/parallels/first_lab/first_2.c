// gcc-14 -Wall first_lab/first_2.c shared/std/* -fopenmp -o executables/first2.bin
// avg. time: 23.27 seconds on 100000x100000 random matrix (5 times, same matrix)
// avg. time: 1.86 seconds on 50000x50000 random matrix (5 times, same matrix)
